...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'alert',array('class'=>'row_label align-left')); ?>
		<?php echo $form->textArea($model,'alert',array('class'=>'text-input large-input','rows'=>10)); ?>
