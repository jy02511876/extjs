...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'times',array('class'=>'row_label align-left')); ?>
		<?php echo $form->textField($model,'times',array('maxlength'=>10,'class'=>'text-input')); ?>
