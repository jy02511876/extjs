...
Ext.onReady(function(){
    ...
    Ext.define('Admin.basic.searchForm.secret',{
    ...
    Ext.define('Admin.basic.grid.secret',{
        ...
        },'-',
        {
            ...
            text:'编辑',
            handler : function(){
                var rows = secretGrid.getSelection();
                if(rows.length != 1){
                    tip('请选择要编辑的数据！');
                    return;
                }
    ...
    //搜索块
    var secretSearchForm = new Admin.basic.searchForm.secret();
    secretSearchForm.render(Ext.getBody());
    //列表
    var secretGrid = new Admin.basic.grid.secret();
    secretGrid.render(Ext.getBody());
    //初始化数据集
    storeReload(store,1);	
});
</script>